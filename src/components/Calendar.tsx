...
const Calendar: React.FC = () => {
    ...
    let generatorCalendar = () => {
        ...
        const preLastday: number = new Date(_date.getFullYear(), _date.getMonth(), 0).getDate();
    ...
    return (
        <div className="callender">
            <div className="month">
                <ul>
                    <li className="prev" onClick={function () { setDate(new Date(_date.getFullYear(), _date.getMonth() - 1)) }}>&#10094;</li>
                    <li className="next" onClick={function () { setDate(new Date(_date.getFullYear(), _date.getMonth() + 1)) }}>&#10095;</li>
                    <li>
